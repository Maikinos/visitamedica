var RenderList = React.createClass({ displayName: "RenderList",
    ...
    var list = data.map(function (entry, index) {
      return (
        React.createElement("tr", null,
          React.createElement("td", { className: "country" }, entry.country.substr(0, 30)),
          React.createElement("td", { className: "capital" }, entry.capital),
          React.createElement("td", { className: "region" }, entry.region),
          React.createElement("td", { className: "subregion" }, entry.subregion),
          React.createElement("td", { className: "lat" }, parseFloat(entry.coordinates[0]).toFixed(2)),
          React.createElement("td", { className: "lon" }, parseFloat(entry.coordinates[1]).toFixed(2))));


    }, this);
    return (
      React.createElement("table", null,
        React.createElement("tr", { className: "tableHead" },
          React.createElement("th", null, "Country"),
          React.createElement("th", null, "Capital"),
          React.createElement("th", null, "Region"),
          React.createElement("th", null, "Subregion"),
  ...
  render: function render() {
    return (
      React.createElement("div", null,
        React.createElement("h1", { className: "title" }, "Country/Capital Data Multi-Search Service"),
