!function(e) {
    ...
    t.prototype.createAreaChart=function(e, t, a, i, r, o, n, c) {
        Morris.Area( {
            element: e, pointSize: 0, lineWidth: 0, data: i, xkey: r, ykeys: o, labels: n, resize: !0, gridLineColor: "#eee", hideHover: "auto", lineColors: c, fillOpacity: .7, behaveLikeLine: !0
        }
        )
    }
    ,
    t.prototype.createDonutChart=function(e, t, a) {
        Morris.Donut( {
            element: e, data: t, resize: !0, colors: a
        }
        )
    }
    ,
    ...
    t.prototype.init=function() {
        ...
        ], "y", ["a", "b", "c"], ["Series A", "Series B", "Series C"], ["#ccc", "#f16c69", "#28bbe3"]);
